...
export const newProviderAccountEmailTemplate = (
  { email, firstName, lastName, title }: Provider,
  pwd: string
) => {
  const query = {
    Destination: {
                      ...
                      <table style="padding: 30px 40px 30px 40px;">
                        ...
                        <tr>
                          <td style="font-family:Helvetica,Arial,sans-serif; font-size: 16px; line-height: 24px;">
                            ...
                            To access your dashboard <a href='${ACNE_APP_URL}' target='_blank'>click here</a> <br />
                          </td>
                        </tr>
                        <tr>
                          <td style="font-size: 0; line-height: 0;" height="20">&nbsp;</td>
