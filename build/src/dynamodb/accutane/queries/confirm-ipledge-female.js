...
exports.default = (patient, accutane, confirmed) => {
    const query = {
        ...
        UpdateExpression: "set #iPledgeConsent.#updatedAt=:UPDATED_AT, #iPledgeConsent.#confirmed=:CONFIRMED, #nextConfirmationDate=:NEXT_CONFIRMATION_DATE, #lastConfirmationDate=:LAST_CONFIRMATION_DATE, #birthControl.#completed=:COMPLETED, #pregnancyTest.#completed=:COMPLETED, #bloodWork.#completed=:COMPLETED, #bloodWork.#confirmed=:CONFIRMED",
...
//# sourceMappingURL=confirm-ipledge-female.js.map