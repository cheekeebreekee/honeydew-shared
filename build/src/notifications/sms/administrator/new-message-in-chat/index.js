...
const newMessageInChat = async (admin) => {
    (0, logger_1.logInfo)("Sending SMS message to administrator about new message in chat", {
        admin,
    });
    const smsMessageParams = {
        ...
        PhoneNumber: (admin.phone && (0, trim_phone_number_1.trimPhoneNumber)(admin.phone)) || "",
        MessageAttributes: {
    ...
    (0, logger_1.logInfo)("Administrator notified successfully");
};
