...
exports.membershipConfirmationMultiTemplate = void 0;
const constants_1 = require("../../../constants");
const logger_1 = require("../../../utils/logger");
const membershipConfirmationMultiTemplate = (email, subscriptionType, paymentAmount, discount) => {
    const query = {
        Destination: {
            ToAddresses: [email],
        },
...
exports.membershipConfirmationMultiTemplate = membershipConfirmationMultiTemplate;
//# sourceMappingURL=patient-membership-confirmation-multi.js.map