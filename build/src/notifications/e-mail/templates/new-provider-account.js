...
exports.newProviderAccountEmailTemplate = void 0;
const constants_1 = require("../../../constants");
const logger_1 = require("../../../utils/logger");
const newProviderAccountEmailTemplate = ({ email, firstName, lastName, title }, pwd) => {
    const query = {
        Destination: {
            ToAddresses: [email],
        },
...
exports.newProviderAccountEmailTemplate = newProviderAccountEmailTemplate;
//# sourceMappingURL=new-provider-account.js.map