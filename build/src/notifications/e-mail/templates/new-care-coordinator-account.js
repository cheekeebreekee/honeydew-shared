...
exports.newCareCoordinatorAccountEmailTemplate = void 0;
const constants_1 = require("../../../constants");
const logger_1 = require("../../../utils/logger");
const newCareCoordinatorAccountEmailTemplate = ({ email, firstName, lastName }, pwd) => {
    const query = {
        Destination: {
            ToAddresses: [email],
        },
...
exports.newCareCoordinatorAccountEmailTemplate = newCareCoordinatorAccountEmailTemplate;
//# sourceMappingURL=new-care-coordinator-account.js.map