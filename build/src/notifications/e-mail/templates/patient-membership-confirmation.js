...
exports.membershipConfirmationTemplate = void 0;
const constants_1 = require("../../../constants");
const logger_1 = require("../../../utils/logger");
const membershipConfirmationTemplate = (email, login, subscriptionType, paymentAmount, discount) => {
    const query = {
        Destination: {
            ToAddresses: [email],
        },
                    ...
                    <table style="padding: 30px 40px 30px 40px;">
                      ...
                      <tr>
                        <td style="font-family:Helvetica,Arial,sans-serif; font-size: 16px; line-height: 24px;">
                          Your sign up is complete and you're all set to begin your acne-free journey. <br />
                          Subscription type: ${constants_1.SUBSCRIPTIONS_PRETTY[subscriptionType]} <br />
                          Order total: $${paymentAmount / 100} <br />
                          ${discount
                        ? `Coupon discount: ${discount}% <br />`
                        : ""}
                          Your sign-in email: ${login} <br />
                          To access your patient dashboard <a href='${constants_1.ACNE_APP_URL}' target='_blank'>click here</a> <br />
...
exports.membershipConfirmationTemplate = membershipConfirmationTemplate;
//# sourceMappingURL=patient-membership-confirmation.js.map