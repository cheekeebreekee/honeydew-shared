...
exports.newVisitNotesSubmittedEmailTemplate = void 0;
const constants_1 = require("../../../constants");
const logger_1 = require("../../../utils/logger");
const newVisitNotesSubmittedEmailTemplate = (email, name) => {
    const query = {
        Destination: {
            ToAddresses: [email],
        },
                    ...
                    <table style="padding: 30px 40px 30px 40px;">
                      ...
                      <tr>
                        <td style="font-family:Helvetica,Arial,sans-serif; font-size: 16px; line-height: 24px;">
                          ...
                          Please login to your <a href='${constants_1.ACNE_APP_URL}' target='_blank'>Honeydew dashboard</a> to view the
...
exports.newVisitNotesSubmittedEmailTemplate = newVisitNotesSubmittedEmailTemplate;
//# sourceMappingURL=new-visit-notes.js.map